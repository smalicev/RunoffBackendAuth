import { cumulate, incrementCumulative, calculateAverage } from "./numericalMethods.mjs";

class Storm {
  constructor(id = null, name, timeData = [0, 15, 30, 45, 60, 75, 90, 105, 120, 135, 150, 165, 180], precipitationDataIntensity = [5,8,12,55,74,112,78,56,55,32,4,2,1] ) {
    this.timeData = timeData;
    this.timeStep = timeData[1] - timeData[0];
    this.precipitationDataIntensity = precipitationDataIntensity;
    this.precipitationData = this.intensityToValues(this.precipitationDataIntensity)
